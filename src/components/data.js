...
export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Having homes will take care of your property and ensure your rental.Inspection monitoring all property management service will be taken care",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The property is surrounded by various amenities such as parks, schools, and shopping centers, providing a convenient and comfortable lifestyle.",
  },
  {
    question: "What security measures are in place for the property?",
    answer:
      "The property is equipped with state-of-the-art security systems, including surveillance cameras, secure access points, and on-site security personnel, ensuring the safety of residents.",
  },
];
...
export const LocationData = {
  ...
  "2-4KM": {
    ...
    "EDUCATIONAL INSTITUTIONS": [
      "IIIT - Indian Institute of Information and Technology",
      "Kreya International University",
      "Accord International School",
      "Chinnmaya Vidya Mandir - CBSE",
      "Padmavathi CBSE School",
    ],
  },
  "4-6KM": {
    "INDUSTRIAL CLUSTER": [
      "Kellogg’s",
      "Alstom Metro Rail Pvt Ltd",
      "Bluestar Air Conditioning",
      "Amber Enterprises",
      "Kikuwa",
      "KCL",
      "Paques Swiz Cleaning",
      "Be Rollex",
      "Indo Space",
      "NGC Transmission",
    ],
  ...
  "7 KM+": {
    "INDUSTRIAL CLUSTER & FTWZ": [
      ...
      "Siddhartha FTWZ",
      "TVS Brakes India",
      "Sricity Business Center",
    ],
    TEMPLES: [
      "Chengalamma Parameswari temple",
      "Oneness Temple",
      "Sri Kasi Visveshwara Temple - Mambattu",
    ],
    "ICONIC & TOURIST PLACES TO VISIT": [
      "ISRO Rocket Launch center",
      "Pullicat Lake - Fishing & Boating",
      "Tada Waterfalls - for trekking",
      "Nelapattu Bird Sanctuary",
      "One Ness - Kalki Golden Temple",
...
export const cardData = [
  ...
  },
  {
    ...
    back: {
      description:
        "Wires: Use BESSCOM-approved ISI Mark top brands like Finolex or V Guard for lighting and heating circuits with ISI-branded PVC conduits. Switches: Install BESSCOM-approved ISI Mark modular switches from reputed brands like Legrand or Crabtree. Air-Conditioning: Provide AC points in all bedrooms and living areas.",
    },
  },
  {
    id: 3,
    ...
    back: {
      description:
        "Professionally planned landscape with appropriate lighting.",
    },
  },
  {
    id: 4,
    ...
    back: {
      description:
        "Use 20 mm thick Engineered Quartz Granite for kitchen countertops, and provide stainless steel sinks with drain boards.",
    },
  },
  {
    id: 5,
  ...
  },
  {
    ...
    back: {
      description:
        "Use EXXARO Brand or equivalent Digital Vitrified Tiles for living areas and bedrooms. Laminated wooden flooring for the master bedroom.",
    },
  },
  {
    id: 7,
    ...
    back: {
      description:
        "Use 20 mm thick high-quality granite for the staircase with wood railings and glass & SS brackets.",
    },
  },
  {
    id: 8,
    ...
    back: {
      description:
        "High-quality glazed ceramic tiles for kitchen dadoing and bathrooms.",
    },
  },
  {
    id: 9,
    ...
    back: {
      description:
        "Main door: Teak wood frame with teak shutter. Other doors: Good quality Sal wood frame with solid door shutters.",
    },
  },
  {
    id: 10,
    ...
    back: {
      description:
        "Three-track high-quality UPVC frames with mosquito mesh shutters.",
    },
  },
  {
    id: 11,
  ...
  },
  {
    ...
    back: {
      description:
        "Use high-quality sanitary fittings like KOHLER Brand or equivalent for bathrooms.",
    },
  },
  {
    id: 13,
    ...
    back: {
      description:
        "Install CCTV cameras in identified common areas and the clubhouse, with monitoring and recording from the security/maintenance office.",
    },
  },
];
...
export const timeline = [
  {
    header: "Unique Location",
    content: "Property in Tada with a view of ISRO Space Station Launch Pad.",
    img: ISRO,
  },
  {
    header: "Largest Gated Community",
    content: "Spanning 21 acres, the largest in SriCity Tada",
    img: Community,
  },
  {
    header: "Rental Income",
    content: "Opportunity for rental property income.",
    img: Income,
  },
  {
    header: "Strategic Location",
    content: "Opposite SriCity entrance, providing easy access.",
    img: Entrance,
  },
  {
    header: "Proximity to Industries",
    content: "150+ companies within 5 minutes.",
    img: Companies,
  },
  {
    header: "Education Hub",
    content: "Access to the best schools and institutions.",
    img: School,
  },
];
